...
public enum WS_URL_EnvioNF {
	...
	//55 - NF-e
	SVRS_HOMOLOGACAO("https://nfe-homologacao.svrs.rs.gov.br/ws/NfeAutorizacao/NFeAutorizacao.asmx","AC|AL|AP|DF|PB|RJ|RN|RO|RR|SC|SE|TO|ES|PI",
			Ambiente.HOMOLOGACAO,TipoEmissao.NORMAL,ModeloDF.MODELO_NFE),
	SVRS_PRODUCAO("https://nfe.svrs.rs.gov.br/ws/NfeAutorizacao/NFeAutorizacao.asmx","AC|AL|AP|DF|PB|RJ|RN|RO|RR|SC|SE|TO|ES|PI",
	...
	SVAN_HOMOLOGACAO("https://hom.sefazvirtual.fazenda.gov.br/NfeAutorizacao/NfeAutorizacao.asmx","MA|PA",Ambiente.HOMOLOGACAO,TipoEmissao.NORMAL,ModeloDF.MODELO_NFE),
	SVAN_PRODUCAO("https://www.sefazvirtual.fazenda.gov.br/NfeAutorizacao/NfeAutorizacao.asmx","MA|PA",Ambiente.PRODUCAO,TipoEmissao.NORMAL,ModeloDF.MODELO_NFE),

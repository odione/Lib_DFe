...
public class RecepcaoEventoStub extends org.apache.axis2.client.Stub {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult nfeRecepcaoEvento(
        br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg nfeDadosMsg0,
        br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE nfeCabecMsg1)
        ...
        try {
            ...
            _operationClient.getOptions()
                            .setAction("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento/nfeRecepcaoEvento");
                ...
                public void onMessage(
                    ...
                    try {
                        ...
                        java.lang.Object object = fromOM(resultEnv.getBody()
                                                                  .getFirstElement(),
                                br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult.class);
                        callback.receiveResultnfeRecepcaoEvento((br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(
        br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg param,
    ...
    private org.apache.axiom.om.OMElement toOM(
        br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    ...
                    br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg.MY_QNAME,
                    factory));
    ...
    private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
        ...
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeCabecMsgE.class.equals(
                        type)) {
            ...
            if (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeDadosMsg.class.equals(
                        type)) {
            ...
            if (br.inf.portalfiscal.www.nfe.wsdl.recepcaoevento.RecepcaoEventoStub.NfeRecepcaoEventoResult.class.equals(
                        type)) {
    ...
    public static class NfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento",
                "nfeDadosMsg", "");
    ...
    public static class ExtensionMapper {
        public static java.lang.Object getTypeObject(
            ...
            if ("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento".equals(
        ...
        public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            if (serializeType) {
                ...
                if ((namespacePrefix != null) &&
                    ...
                    writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":nfeRecepcaoEventoResult", xmlWriter);
                } else {
                    writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                    ...
                    if (reader.getAttributeValue(
                        ...
                        if (fullTypeName != null) {
                            ...
                            if (!"nfeRecepcaoEventoResult".equals(type)) {
                                ...
                                return (NfeRecepcaoEventoResult) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                            }
                        }
                    }
